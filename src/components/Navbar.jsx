        ...
        <nav class="bg-white border-gray-200 dark:bg-gray-900">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                <Link className="flex items-center space-x-3 rtl:space-x-reverse" href={"/"}>
                    ...
                    <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">SocializeSpot</span>
                </Link>
                ...
                <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-search">
                    ...
                    <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                        <li>
                            <Link className={`block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent ${isHomePage ? 'md:text-blue-700 md:dark:text-blue-500' : ''} md:p-0`} href={"/"}>Home</Link>
                        </li>
                        <li>
                            <Link className={`block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 md:dark:hover:text-blue-500 ${isMyBlogPage ? 'md:text-blue-700 md:dark:text-blue-500' : 'dark:text-white'} dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700`} href={"/myBlogs"}>My Blogs</Link>
                        </li>
                        <li>
                            <Link className={`block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0  ${isWriteBlogPage ? 'md:text-blue-700 md:dark:text-blue-500' : 'dark:text-white'} md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700`} href={"/addBlog"}>Write Blog</Link>
                        </li>
                        <li>
