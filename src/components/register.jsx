...
const Register = () => {
  ...
  return (
    <section className='w-5/6 md:w-3/4 mx-auto flex flex-col gap-4 md:gap-10'>
      <div className='title'>
        <h1 className='text-gray-800 text-2xl md:text-4xl font-bold py-4'>Register</h1>
        <p className='w-3/4 mx-auto text-gray-400'>Share your voice with the world - register and start writing!</p>
      </div>
